...
enum UiOption {
	UI_OPTION_NONE = 0,
	UI_OPTION_GUTTER = 1 << 0,
	UI_OPTION_LINE_NUMBERS_ABSOLUTE = 1 << 1,
	UI_OPTION_LINE_NUMBERS_RELATIVE = 1 << 2,
	UI_OPTION_SYMBOL_SPACE = 1 << 3,
	UI_OPTION_SYMBOL_TAB = 1 << 4,
	UI_OPTION_SYMBOL_TAB_FILL = 1 << 5,
	UI_OPTION_SYMBOL_EOL = 1 << 6,
	UI_OPTION_SYMBOL_EOF = 1 << 7,
	UI_OPTION_CURSOR_LINE = 1 << 8,
	UI_OPTION_STATUSBAR = 1 << 9,
	UI_OPTION_ONELINE = 1 << 10,
	UI_OPTION_LARGE_FILE = 1 << 11,
};
...
enum UiStyle {
	...
	UI_STYLE_INFO,
	UI_STYLE_EOF,
	/* dynamic style space starts at 100 */
	UI_STYLE_MAX = 200,
};
